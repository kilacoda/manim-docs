...
class GraphScene(Scene):
    """
    manimlib.scene.graph_scene.GraphScene

    Graph Scene
    ===========

    Creates a customizable Cartesian (x-y) axis system.
    Used mainly to draw algebraic plots.\n
    If you're looking for the blue gridded plane shown in 3Blue1Brown's videos,
    see:

    1. ``NumberPlane`` (manimlib.mobject.coordinate_systems.NumberPlane)\n

    2. ``LinearTransformationScene`` (manimlib.scene.vector_space_scene.LinearTransformationScene)
    ...
    * default_derivative_color\n
    * default_input_color\n
    * default_riemann_start_color\n
    * default_riemann_end_color\n
    * area_opacity\n
    * num_rects\n
    """
