"""
Contains the `Text` class, with which one can write with other system-wide fonts.

See https://github.com/3b1b/manim/pull/680 for more info on this.
"""
...
class Text(SVGMobject):
    """
    `manimlib.mobject.svg.text_mobject.Text`
    Text
    ====

    Writes text using `cairo`, has UTF-8 and multiline support and can be used
    to write in other(non-English) languages as well.
    ...
    For more info: https://github.com/3b1b/manim/pull/680
