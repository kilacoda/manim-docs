"""
Most of these animations are self-explanatory, so I've saved myself the work
of writing docstrings for them. If you'd like to see some of your own written
docstrings, feel free to send me a PR.
    - KilaCoda
"""
