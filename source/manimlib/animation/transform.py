...
class Transform(Animation):
    """
    `manimlib.animation.transform.Transform`

    Transform
    =========
    Transforms `mobject` into `target_mobject`, WITHOUT replacing the former.
    """
    CONFIG = {
        "path_arc": 0,
        "path_arc_axis": OUT,
...
class ReplacementTransform(Transform):
    """
    `manimlib.animation.transform.ReplacementTransform`

    Transform
    =========
    Transforms `mobject` into `target_mobject`, while replacing the former.
    """
    CONFIG = {
